<template>
    <Row type="flex" justify="center" align="middle" :class-name="'account-container'">
        <Col>
                        ...
                        <Col :xs="{span:22,offset:1}" :sm="{span:22,offset:1}" :lg="{span:22,offset:1}">
                            <Row v-if="tab=='login'">
                                ...
                                <Col :xs="24" :sm="24" :lg="24">
                                    <Button  @click="login" class="submit-button">&nbsp登录</Button>
                                </Col>
                            </Row>
                            <Row v-if="tab=='register'">
                                ...
                                <Col :xs="24" :sm="24" :lg="24">
                                    <Button  @click="register" class="submit-button">&nbsp注册</Button>
                                </Col>
                            </Row>
...
.account-container{
    height: 100%;
    background: url('/static/accout_background.png') center center no-repeat;
