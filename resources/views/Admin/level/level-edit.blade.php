...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-admin">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="{{$obj->min}}" placeholder="" id="min" name="min">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="{{$obj->max}}" placeholder="" id="max" name="max">
			</div>
		</div>
		<div class="row cl">
    ...
    $("#form-admin").validate({
        ...
        submitHandler:function(form){
            ...
            $(form).ajaxSubmit({
                ...
                url: '/{{config('base.admin')}}/level/level_edit/{{$obj->id}}', // 需要提交的 url
