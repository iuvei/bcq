...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>发送全员(type)：</label>
			<div class="formControls col-xs-8 col-sm-8 skin-minimal">
				...
				<div class="radio-box">
					<input type="radio" id="type-2" value="0" name="type" @if($obj->type == 0) checked @endif>
        ...
        $("#form-admin").validate({
            ...
            submitHandler:function(form){
                ...
                $(form).ajaxSubmit({
                    ...
                    url: '/{{config('base.admin')}}/mail/mail_edit/{{$obj->id}}', // 需要提交的 url
