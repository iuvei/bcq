...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8 skin-minimal">
				@foreach(config('base.access') as $key => $val)
					<div class="check-box">
						<input type="checkbox" id="acc-{{$key}}" value="{{$key}}" name="acc">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8 skin-minimal">
				@foreach(config('base.region') as $key => $val)
					<div class="check-box">
						<input type="radio" id="region-{{$key}}" value="{{$key}}" name="region">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="" placeholder="" id="url1" name="url1">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">网址2(url2)：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="" placeholder="" id="url2" name="url2">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">网址3(url3)：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="" placeholder="" id="url3" name="url3">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">网址4(url4)：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="" placeholder="" id="url4" name="url4">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>总分(mark)：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="" placeholder="" id="mark" name="mark">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>评分1(mark1)：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="" placeholder="" id="mark1" name="mark1">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>评分2(mark2)：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="" placeholder="" id="mark2" name="mark2">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>评分3(mark3)：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="" placeholder="" id="mark3" name="mark3">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>评分4(mark4)：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="" placeholder="" id="mark4" name="mark4">
			</div>
		</div>
		<div class="row cl">
	...
	$("#form-admin").validate({
        ...
        submitHandler:function(form){
            ...
            $(form).ajaxSubmit({
                ...
                url: '/{{config('base.admin')}}/cash/cash_add', // 需要提交的 url
