	...
	<form class="form form-horizontal" id="form-admin">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8 skin-minimal">
				<div class="radio-box">
					<input type="radio" id="head-1" value="1" name="head" checked>
					<label for="head-1">是</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="head-2" value="0" name="head">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8 skin-minimal">
				<div class="radio-box">
					<input type="radio" id="byself-1" value="1" name="byself">
					<label for="byself-1">是</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="byself-2" value="0" name="byself" checked>
	...
	$("#form-admin").validate({
        ...
        submitHandler:function(form){
            ...
            $(form).ajaxSubmit({
                ...
                url: '/{{config('base.admin')}}/news/news_add', // 需要提交的 url
