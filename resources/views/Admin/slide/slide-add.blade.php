...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 首页轮播管理 <span class="c-gray en">&gt;</span> 添加首页轮播资讯 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<form method="POST" id="list_form" action="/{{config('base.admin')}}/slide/slide_add/{{$type}}">
		{{ csrf_field() }}
		<div class="text-c">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a href="javascript:;" onclick="data_insert('/{{config('base.admin')}}/slide/slide_insert/{{$type}}')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 批量添加到首页轮播</a>
        </span>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('.table-sort').dataTable({
            ...
            "sAjaxSource": "/{{config('base.admin')}}/slide/slide_ajax_add/{{$type}}",
            "aaSorting": [
                [0, "desc"],
            ],
            "aoColumns": [
