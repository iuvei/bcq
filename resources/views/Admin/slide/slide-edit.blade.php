...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>标题(brief)：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="{{$obj->brief}}" placeholder="" id="brief" name="brief">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>链接(url)：</label>
			<div class="formControls col-xs-8 col-sm-8">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>轮播类型(type)：</label>
			<div class="formControls col-xs-8 col-sm-8 skin-minimal">
				<div class="radio-box">
					<input type="radio" id="type-1" value="1" name="type" @if($obj->type == 1) checked @endif>
					<label for="type-1">轮播</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="type-2" value="2" name="type" @if($obj->type == 2) checked @endif>
					<label for="type-2">卡片</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="type-3" value="3" name="type" @if($obj->type == 3) checked @endif>
					<label for="type-3">全部</label>
				</div>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>封面图片(image)：</label>
			<div class="formControls col-xs-8 col-sm-8">
        ...
        $("#form-admin").validate({
            ...
            submitHandler:function(form){
                ...
                $(form).ajaxSubmit({
                    ...
                    url: '/{{config('base.admin')}}/slide/slide_edit/{{$obj->id}}', // 需要提交的 url
