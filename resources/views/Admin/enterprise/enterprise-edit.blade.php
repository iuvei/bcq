...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>规模(scale)：</label>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">博招聘外链地址(url)：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="{{$obj->url}}" placeholder="" id="url" name="url">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>LOGO(logo)：</label>
			<div class="formControls col-xs-8 col-sm-8">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">名企(famous)：</label>
			<div class="formControls col-xs-8 col-sm-8 skin-minimal">
				<div class="radio-box">
        ...
        $("#form-admin").validate({
            ...
            submitHandler:function(form){
                ...
                $(form).ajaxSubmit({
                    ...
                    url: '/{{config('base.admin')}}/enterprise/enterprise_edit/{{$obj->id}}', // 需要提交的 url
