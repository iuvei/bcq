...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>名展(famous)：</label>
			<div class="formControls col-xs-8 col-sm-8 skin-minimal">
				<div class="radio-box">
					<input type="radio" id="famous-0" value="0" name="famous" @if($obj->famous == 0) checked @endif>
					<label for="famous-0">否</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="famous-1" value="1" name="famous" @if($obj->famous == 1) checked @endif>
					<label for="famous-1">是</label>
				</div>
			</div>
		</div>

		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>开始日期(starttime)：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd 00:00:00'})" id="starttime" name="starttime" class="input-text Wdate" style="width:40%;" value="{{date('Y-m-d H:i:s',$obj->starttime)}}">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>结束日期(endtime)：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd 23:59:59'})" id="endtime" name="endtime" class="input-text Wdate" style="width:40%;" value="{{date('Y-m-d H:i:s',$obj->endtime)}}">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>简称(short)：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="{{$obj->short}}" placeholder="" id="short" name="short">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>主办方(sponsor)：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="{{$obj->sponsor}}" placeholder="" id="sponsor" name="sponsor">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>举办地(address)：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="{{$obj->address}}" placeholder="" id="address" name="address">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>展会简介(content)：</label>
			<div class="formControls col-xs-8 col-sm-8">
        ...
        $("#form-admin").validate({
            ...
            submitHandler:function(form){
                ...
                $(form).ajaxSubmit({
                    ...
                    url: '/{{config('base.admin')}}/show/show_edit/{{$obj->id}}', // 需要提交的 url
