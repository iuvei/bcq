...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8 skin-minimal">
				@foreach(config('base.trendsType') as $key => $val)
					<div class="check-box">
						<input type="checkbox" id="ty-{{$key}}" value="{{$key}}" name="ty">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="" placeholder="" id="product_url" name="product_url">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>产品内容(content)：</label>
			<div class="formControls col-xs-8 col-sm-8">
	...
	$("#form-admin").validate({
        ...
        submitHandler:function(form){
            ...
            $(form).ajaxSubmit({
                ...
                url: '/{{config('base.admin')}}/trends/trends_add', // 需要提交的 url
