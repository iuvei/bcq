...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">推送(hot)：</label>
			<div class="formControls col-xs-8 col-sm-8 skin-minimal">
				<div class="radio-box">
					<input type="radio" id="hot-0" value="0" name="hot" @if($obj->hot == 0) checked @endif>
					<label for="hot-0">否</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="hot-1" value="1" name="hot" @if($obj->hot == 1) checked @endif>
        ...
        $("#form-admin").validate({
            ...
            submitHandler:function(form){
                ...
                $(form).ajaxSubmit({
                    ...
                    url: '/{{config('base.admin')}}/special/special_edit/{{$obj->id}}', // 需要提交的 url
