...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-admin">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>分类名称(gname)：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="{{$obj->gname}}" placeholder="" id="gname" name="gname">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>分类图片(image)：</label>
			<div class="formControls col-xs-8 col-sm-8">
	...
	$("#form-admin").validate({
		...
		submitHandler:function(form){
            ...
            $(form).ajaxSubmit({
                ...
                url: '/{{config('base.admin')}}/news_category/category_edit/{{$obj->id}}', // 需要提交的 url
