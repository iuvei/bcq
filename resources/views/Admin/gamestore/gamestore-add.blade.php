	...
	<form class="form form-horizontal" id="form-admin">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8 skin-minimal">
				<div class="radio-box">
					<input type="radio" id="money-1" value="1" name="money" checked>
					<label for="money-1">有</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="money-2" value="0" name="money">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="0" placeholder="" id="access_point" name="access_point">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8 skin-minimal">
				@foreach($category as $key => $val)
					<div class="check-box">
						<input type="checkbox" id="w-{{$val->id}}" value="{{$val->weight}}" name="w" />
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8">
				<textarea id="brief" name="brief" type="text/plain"></textarea>
			</div>
		</div>
		<div class="row cl">
	...
	$("#form-admin").validate({
        ...
        submitHandler:function(form){
            ...
            $(form).ajaxSubmit({
                ...
                url: '/{{config('base.admin')}}/gamestore/gamestore_add', // 需要提交的 url
