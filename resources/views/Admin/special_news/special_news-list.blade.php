...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 专题管理 <span class="c-gray en">&gt;</span> 专题资讯列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<form method="POST" id="list_form" action="/{{config('base.admin')}}/special_news/special_news_list/{{$sid}}">
		{{ csrf_field() }}
		<div class="text-c">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a href="javascript:;" onclick="datastatus(1,'/{{config('base.admin')}}/special_news/datastatus')" class="btn btn-success radius"><i class="Hui-iconfont">&#xe6e1;</i> 批量启用</a>
            <a href="javascript:;" onclick="datastatus(0,'/{{config('base.admin')}}/special_news/datastatus')" class="btn btn-warning radius"><i class="Hui-iconfont">&#xe631;</i> 批量禁用</a>
            <a href="javascript:;" onclick="datastatus(-1,'/{{config('base.admin')}}/special_news/datastatus')" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
            <a href="javascript:;" onclick="special_news_add('未添加资讯列表','/{{config('base.admin')}}/special_news/special_news_add/{{$sid}}',1000,'')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 未添加资讯列表</a>
        </span>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('.table-sort').dataTable({
            ...
            "sAjaxSource": "/{{config('base.admin')}}/special_news/special_news_ajax_list/{{$sid}}",
            "aaSorting": [
                [0, "desc"],
            ],
            "aoColumns": [
    ...
    /*专题资讯-添加*/
    function special_news_add(title,url,w,h){
